...
namespace ControleEstoque.App.Dtos
{
    public class ProdutoView
    {
        ...
        public ProdutoView() { }
        public ProdutoView(ProdutoEntity entity)
        {
            this.Id = entity.Id;
        ...
        public static implicit operator ProdutoEntity(ProdutoView model)
        {
            return new ProdutoEntity
            {
                Id = model.Id,
        ...
        public static implicit operator ProdutoView(ProdutoEntity model)
        {
