...
{
    class EntradaProdutoMap : IEntityTypeConfiguration<EntradaProdutoEntity>
    {
        public void Configure(EntityTypeBuilder<EntradaProdutoEntity> builder)
        {
            builder.ToTable("entrada_produto");//nome da tabela
            ...
            builder.HasOne(p => p.Produto)//um produto
                .WithMany()//tem muitas entrada de produto
